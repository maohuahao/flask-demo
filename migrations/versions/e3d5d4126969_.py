...
Revision ID: e3d5d4126969
Revises: 5dd75eea1f3b
Create Date: 2023-03-30 21:11:34.985626
...
revision = 'e3d5d4126969'
down_revision = '5dd75eea1f3b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('serious_illegal_temp', schema=None) as batch_op:
