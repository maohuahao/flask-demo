...
class LocalNewJob(db.Model):
    __bind_key__ = 'localhost'
    id = db.Column(db.Integer, primary_key=True)
    ...
    welfare = db.Column(db.String(100))
    education = db.Column(db.String(100))
    size1 = db.Column(db.String(100))
    job_1st_class = db.Column(db.String(100))
    ...
    title_abbr = db.Column(db.String(100))
    city_code = db.Column(db.String(100))
    start_date = db.Column(db.String(100))


class LocalNewJobSchema(Schema):
    id = fields.Integer()
    eid = fields.String()
    name = fields.String()
    ...
    sex = fields.String()
    welfare = fields.String()
    education = fields.String()
    size1 = fields.String()
    job_1st_class = fields.String()
    years = fields.String()
    salary = fields.String()
    employer_type = fields.String()
    industry = fields.String()
    age = fields.String()
    position = fields.String()
    title_abbr = fields.String()
    city_code = fields.String()
    start_date = fields.String()
